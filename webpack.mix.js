...
mix
    ...
    //COMPONENTS
    // .js('src/js/components/example-component.js', 'assets/js/components/example-component.min.js')
    // .sass('src/scss/components/example-component.scss', 'assets/css/components/example-component.min.css')
